...
```
Welcome to Homescript interactive v2.15.0. CLI commands and comments start with #
...
## Help Output
```
homescript-cli v2.15.0 : A command line interface for the smarthome server using homescript
