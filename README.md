...
```
Welcome to Homescript interactive v2.11.1. CLI commands and comments start with #
...
## Help Output
```
homescript-cli v2.11.1 : A command line interface for the smarthome server using homescript
...
## Installation of v2.11.1 (for Linux/AMD64)

```
cd /tmp && wget https://github.com/smarthome-go/cli/releases/download/v2.11.1/homescript_linux_amd64.tar.gz && tar -xvf homescript_linux_amd64.tar.gz && sudo mv homescript /usr/bin && rm -rf homescript_linux_amd64.tar.gz
```
